...
export const ScrapInvoice: React.FC = () => {
    ...
    const fetchCompanyGST = async () => {
        try {
            ...
            console.log('🏢 Company GST API Response:', result);

            if (result.success && result.data) {
                const data: any = result.data;
                console.log('🏢 Setting Company GST:', {
            ...
            console.error('❌ Error fetching company GST config:', error);
        }
    };
    ...
    const fetchItemsList = async () => {
        try {
            ...
            if (itemsRes.success && Array.isArray(itemsRes.data)) {
                ...
                // }
                console.log("📦 Fetched Stock Items:", items.length);
                setItemsList(items);
            }
        } catch (error) {
    ...
    const handleClientChange = async (clientId: string) => {
        ...
        if (client) {
            ...
            console.log('👤 Client Selected:', client.LedgerName);
            console.log('📊 Client GST Info:', { isGst, clientTin });
    ...
    const calculateItemGST = async (item: InvoiceItem, taxableAmount: number) => {
        ...
        console.log('🔄 Calculating GST locally for item:', item.id);
        ...
        console.log('✅ Calculated GST:', { isGstEnabled, isInterState, cgstAmt, sgstAmt, igstAmt, total: taxAmount });
    ...
    const handleItemChange = async (itemId: number, field: string, value: any) => {
        ...
        if (field === 'itemId') {
            ...
            console.log(`📦 Item Change Selected:`, selectedItem);
            ...
            console.log(`📦 Item Changed: ${newItemData.itemName}, Fetched Stock: ${currentStock}, Auto-filled Quantity`);
  ...
  <div class="container">
    ...
    <div class="row" style="align-items: flex-start;">
        ...
        <div style="width: 300px; padding-left: 20px;">
           ...
           <div class="row" style="font-size: 14px; font-weight: bold; border-top: 1px solid #000; margin-top: 5px; padding-top: 5px;"><span class="label" style="width:120px">Grand Total:</span><span class="val text-right">₹ ${printNetAmount.toFixed(2)}</span></div>
        </div>
    </div>
